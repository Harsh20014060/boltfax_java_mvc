...
public class ForgottenPassword extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataBase = new com.application.boltfax.MyDataBase(ForgottenPassword.this);
        ...
        BackToLogin_txt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(ForgottenPassword.this, com.application.boltfax.LoginPage.class));
                finish();
            }
        });
        CreateANewAccount_txt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(ForgottenPassword.this, com.application.boltfax.SignUpPage.class));
                finish();
            }
        });
    }
