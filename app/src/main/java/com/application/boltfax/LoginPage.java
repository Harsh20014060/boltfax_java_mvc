...
public class LoginPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataBase = new com.application.boltfax.MyDataBase(LoginPage.this);
        ...
        forgotten_txt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(LoginPage.this, com.application.boltfax.ForgottenPassword.class));
                finish();
            }
        });
        ...
        signup_txt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(LoginPage.this, com.application.boltfax.SignUpPage.class));
                finish();
            }
        });
                                                  ...
                                                  if (documentSnapshot.exists()) {
                                                      ...
                                                      if (otp.equals("yes")) {
                                                          ...
                                                          if (password_txt.getText().toString().equals(pass)) {
                                                              ...
                                                              d.dismiss();
                                                              startActivity(new Intent(LoginPage.this, com.application.boltfax.MainActivity.class));
                                                              finish();
                                                          } else {
                                                              if (connection()) {
                                                                  d.dismiss();
