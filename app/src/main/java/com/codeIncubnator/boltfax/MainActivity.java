...
import com.codeIncubnator.boltfax.fragments.CartFragement;
import com.codeIncubnator.boltfax.fragments.CategoryFragment;
import com.codeIncubnator.boltfax.fragments.HomeFragment;
import com.codeIncubnator.boltfax.fragments.MenuFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (i == R.id.search) {
            Intent search = new Intent(this, com.codeIncubnator.boltfax.SearchPage.class);
            startActivity(search);
        }
        if (i == R.id.notification) {
            Intent notify = new Intent(this, com.codeIncubnator.boltfax.Notifications.class);
