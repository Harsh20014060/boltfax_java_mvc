...
import com.codeIncubnator.boltfax.adapter.RecyclerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(ProductList.this, com.codeIncubnator.boltfax.MainActivity.class));
            }
        });
...
//                                showData();
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (i == R.id.search) {
            Intent search = new Intent(ProductList.this, com.codeIncubnator.boltfax.SearchPage.class);
            startActivity(search);
        }
        if (i == R.id.notification) {
            Intent notify = new Intent(ProductList.this, com.codeIncubnator.boltfax.Notifications.class);
