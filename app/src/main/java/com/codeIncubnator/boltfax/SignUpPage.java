...
//        get id's of all the UI Components
        ...
        dataBase = new com.codeIncubnator.boltfax.MyDataBase(SignUpPage.this);
        ...
        db.collection("users").document(originalPhoneNumber)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        d.dismiss();
                        startActivity(new Intent(SignUpPage.this, com.codeIncubnator.boltfax.MainActivity.class));
                        finish();
                    }
                })
