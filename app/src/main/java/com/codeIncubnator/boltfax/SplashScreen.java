...
public class SplashScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataBase = new com.codeIncubnator.boltfax.MyDataBase(SplashScreen.this);
        view.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            @Override
            public void onCompletion(MediaPlayer mediaPlayer) {
                Cursor cursor = dataBase.getAllInfo();
                if (cursor.getCount() == 0) {
                    Intent abc = new Intent(SplashScreen.this, com.codeIncubnator.boltfax.LoginPage.class);
                    startActivity(abc);
                } else {
                    Intent abc = new Intent(SplashScreen.this, com.codeIncubnator.boltfax.MainActivity.class);
                    startActivity(abc);
                }
            }
        });
