...
public class DealsOfTheDay_Adapter extends RecyclerView.Adapter<DealsOfTheDay_Adapter.DealsViewHolder> {
    ArrayList<ArrayList<String>> datalist;
    Context c;
    int i = 1;

    public DealsOfTheDay_Adapter(ArrayList<ArrayList<String>> datalist) {
    ...
    public void onBindViewHolder(@NonNull DealsViewHolder holder, int position) {
        ...
        holder.tv3.setText(pr_discount);
